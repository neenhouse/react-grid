		...
		return (
				<div className='react-grid-wrapper'>
					<div className='grid-table'>
						<Head {...this.props} data={this.getData()} columnHeaders={columnHeaders} />
						<Body {...this.props} data={this.getData()} dispatch={this.dispatch.bind(this)} columnHeaders={columnHeaders} />
					</div>
					<Foot {...this.props} data={this.state.data} dispatch={this.dispatch.bind(this)} {...this.state.pager} />
				</div>
		);
	}
}
